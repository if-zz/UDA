...
public class HBaseAPI {
    ...
    // 添加一条数据 example: HBaseAPI.addRow(tableName, "henjun", "info", "age", "19");
    ...
    public static void delRow(String tableName, String row) throws Exception {
        System.out.println("************删除一条:" + row + " 数据************");
        HTable table = new HTable(conf, tableName);
    ...
    public static void main(String[] args) {
        try {
            ...
            if (isExist(tableName)) {
                ...
                //获取一条数据
                //HBaseAPI.getRow(tableName, "zpc");

                // 获取所有数据

                //HBaseAPI.getAllRows(tableName);

                // 第五步：删除一条数据

                HBaseAPI.delRow(tableName, "zpc");
                HBaseAPI.getAllRows(tableName);
                /*// 删除多条数据
                String rows[] = new String[] { "qingqing","xiaoxue" };
                HBaseAPI.delMultiRows(tableName, rows);
                HBaseAPI.getAllRows(tableName);
...
/*HBaseAPI.addRow(tableName, "zpc", "info", "age", "20");
                HBaseAPI.addRow(tableName, "zpc", "info", "sex", "boy");
                HBaseAPI.addRow(tableName, "zpc", "course", "china", "97");
                HBaseAPI.addRow(tableName, "zpc", "course", "math", "128");
                HBaseAPI.addRow(tableName, "zpc", "course", "english", "85");
                // 添加第二行数据
                HBaseAPI.addRow(tableName, "henjun", "info", "age", "19");
                HBaseAPI.addRow(tableName, "henjun", "info", "sex", "boy");
                HBaseAPI.addRow(tableName, "henjun", "course", "china","90");
                HBaseAPI.addRow(tableName, "henjun", "course", "math","120");
                HBaseAPI.addRow(tableName, "henjun", "course", "english","90");
                // 添加第三行数据
                HBaseAPI.addRow(tableName, "niaopeng", "info", "age", "18");
                HBaseAPI.addRow(tableName, "niaopeng", "info", "sex","girl");
                HBaseAPI.addRow(tableName, "niaopeng", "course", "china","100");
                HBaseAPI.addRow(tableName, "niaopeng", "course", "math","100");
                HBaseAPI.addRow(tableName, "niaopeng", "course", "english","99");
                */